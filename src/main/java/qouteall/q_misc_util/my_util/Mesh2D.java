...
public class Mesh2D {
    ...
    public static @Nullable Mesh2D fromTag(CompoundTag tag) {
        ...
        for (int i = 0; i < triangles.size() / 3; i++) {
            ...
            mesh.addTriangle(
                pointCoords.getDoubleOr(p0Index * 2, 0.0D),
                pointCoords.getDoubleOr(p0Index * 2 + 1, 0.0D),
                pointCoords.getDoubleOr(p1Index * 2, 0.0D),
                pointCoords.getDoubleOr(p1Index * 2 + 1, 0.0D),
                pointCoords.getDoubleOr(p2Index * 2, 0.0D),
                pointCoords.getDoubleOr(p2Index * 2 + 1, 0.0D)
            );
        }
